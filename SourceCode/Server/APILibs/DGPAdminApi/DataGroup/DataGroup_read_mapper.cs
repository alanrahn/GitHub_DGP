...
{
    public class DataGroup_read_mapper
    {
        string _connstr;
        string _appname;
        string _pagesize = "50";

        public DataGroup_read_mapper(string connStr)
        {
            _connstr = connStr;
        ...
        public string GetByID(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                if (reqFields)
                {
                    ...
                    DataGroups_read_dml dataGroups_Dml = new DataGroups_read_dml(_connstr);
                    results = dataGroups_Dml.GetByID(GroupGID);
        ...
        public string GetByName(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                if (reqFields)
                {
                    bool schemaflag = Convert.ToBoolean(SchemaFlag);
                    DataGroups_read_dml dataGroups_Dml = new DataGroups_read_dml(_connstr);
                    results = dataGroups_Dml.GetByName(GroupName);
        ...
        public string GetHistory(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                if (reqFields)
                {
                    bool schemaflag = Convert.ToBoolean(SchemaFlag);
                    DataGroups_read_dml dataGroups_Dml = new DataGroups_read_dml(_connstr);
                    results = dataGroups_Dml.GetHistory(GroupGID);
        ...
        public string GetCount(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                if (reqFields)
                {
                    ...
                    string groupcount = dataGroups_Dml.GetCount(GroupName, recstate);
        ...
        public string GetSearch(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                string GroupName = msgUtil.GetParamValue("GroupName", methparams);
                ...
                if (reqFields)
                {
                    bool schemaflag = Convert.ToBoolean(SchemaFlag);
                    DataGroups_read_dml dataGroups_Dml = new DataGroups_read_dml(_connstr);
                    results = dataGroups_Dml.GetSearch(pagenum, _pagesize, recstate, sortorder, GroupName);
        ...
        public string DupeCheck(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                DataGroups_read_dml datagroups_read_Dml = new DataGroups_read_dml(_connstr);
                bool duplicates = datagroups_read_Dml.DupeCheck(userinfo.UserName, _appname);
                ...
                {
                    resultxml = msgUtil.CreateXMLResult(methodname, MethReturn.Default, APIResult.Empty, APIData.Text, "Duplicates were found in the DataGroups table: refer to the error logs for details.");
                }
            }
            catch (Exception ex)
            {
        ...
        public string GetSrcCounts(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                {
                    DataGroups_read_dml datagroups_read_Dml = new DataGroups_read_dml(_connstr);
                    string srccounts = datagroups_read_Dml.GetSrcCounts(srcdbname, endid);
        ...
        public string GetDestCounts(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                {
                    DataGroups_read_dml datagroups_read_Dml = new DataGroups_read_dml(_connstr);
                    string destcounts = datagroups_read_Dml.GetDestCounts(srcdbname);
        ...
        public string GetSource(UserInfo userinfo, string methodname, Dictionary<string, string> methparams)
        {
            ...
            try
            {
                ...
                if (reqFields)
                {
                    bool schemaflag = Convert.ToBoolean(SchemaFlag);
                    DataGroups_read_dml dataGroups_Dml = new DataGroups_read_dml(_connstr);
                    results = dataGroups_Dml.GetSrcRecs(srcdbname, placeholder, batchsize);
